...
if ($cha_itm_loc -eq 'character') {
    ...
    Add-Content -LiteralPath "$cha_name (Character).txt" -Value "$cha_name is a $cha_age $cha_gender $cha_species, and has $cha_color $cha_skin_fur, along with $cha_hair $cha_hair_color hair. $cha_gender_spec is $cha_height in height, and $cha_weight in weight.`n`n$cha_name wears a $cha_clothing_head on $cha_gender_spec2 head, a $cha_clothing_upper_body on $cha_gender_spec2 upper body, $cha_clothing_lower_body on $cha_gender_spec2 lower body, and $cha_clothing_feet.`n`n$cha_name is generally $cha_personality, and they are $cha_traits as well. $cha_gender_spec likes $cha_likes, but dislikes $cha_dislikes. $cha_gender_spec is also afraid of $cha_fears.`n`n$cha_name is $cha_gender_pref, and is currently in a relationship with $cha_relationship. $cha_gender_spec2_c family is: $cha_family; and $cha_gender_spec2 friends are: $cha_friends.`n`n"
    Write-Host "$cha_name is a $cha_age $cha_gender $cha_species, and has $cha_color $cha_skin_fur, along with $cha_hair $cha_hair_color hair. $cha_gender_spec is $cha_height in height, and $cha_weight in weight.`n`n$cha_name wears a $cha_clothing_head on $cha_gender_spec2 head, a $cha_clothing_upper_body on $cha_gender_spec2 upper body, $cha_clothing_lower_body on $cha_gender_spec2 lower body, and $cha_clothing_feet.`n`n$cha_name is generally $cha_personality, and they are $cha_traits as well. $cha_gender_spec likes $cha_likes, but dislikes $cha_dislikes. $cha_gender_spec is also afraid of $cha_fears.`n`n$cha_name is $cha_gender_pref, and is currently in a relationship with $cha_relationship. $cha_gender_spec2_c family is: $cha_family; and $cha_gender_spec2 friends are: $cha_friends.`n`n$cha_name $cha_biography. $cha_gender_spec lives at $cha_home with $cha_roommates."
}
